...
class TileConnectivityLoader:
    ...
    def _load_connectivity_table(self):
        ...
        print(f"[TileConnectivityLoader] Loaded connectivity table: "
    ...
    def table_shape(self) -> tuple:
        ...
        return self._connectivity_table.shape if self._connectivity_table is not None else None
