...
fast_graph_builder and tile_connectivity_precomputer implementations.
"""
...
# It uses a simpler tile-level approach. The fast_graph_builder has the
...
class TestSubnodeValidity(unittest.TestCase):
    ...
    def test_half_tiles(self):
        ...
        self.assertTrue(fast_graph_check(2, 12, 18), "Bottom half should be traversable")
    ...
    def test_quarter_circles(self):
        ...
        self.assertTrue(fast_graph_check(10, 23, 23), "Far corner (23,23) should be traversable")
        self.assertFalse(fast_graph_check(10, 6, 6), "(6,6) is within circle, should be solid")
        ...
        self.assertFalse(fast_graph_check(11, 18, 6), "(18,6) is within circle, should be solid")
        ...
        self.assertFalse(fast_graph_check(12, 18, 18), "(18,18) is within circle, should be solid")
        ...
        self.assertFalse(fast_graph_check(13, 6, 18), "(6,18) is within circle, should be solid")
    ...
    def test_steep_slopes(self):
        ...
        self.assertTrue(fast_graph_check(27, 6, 12), "Left of x=12 should be traversable")
        # Right side depends on diagonal
        
        # Type 29: Left triangle with vertices (12,24), (0,0), (0,24)
        self.assertTrue(fast_graph_check(29, 18, 12), "Right of x=12 should be traversable")
