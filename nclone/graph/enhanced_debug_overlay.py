...
class EnhancedDebugOverlay:
    ...
    def draw_overlay(self, debug_info: Optional[Dict[str, Any]] = None) -> pygame.Surface:
        """
    ...
    def _draw_full_analysis_overlay(self, overlay: pygame.Surface, debug_info: Optional[Dict[str, Any]]):
    ...
    def _draw_path_details(self, overlay: pygame.Surface):
        ...
        for i, (x, y) in enumerate(self.current_path_result.path_coordinates):
            ...
            pygame.draw.circle(overlay, (255, 255, 255, 255), (screen_x, screen_y), 8, 2)
    ...
    def _draw_node_analysis(self, overlay: pygame.Surface):
        ...
        for node_idx in range(self.current_graph_data.num_nodes):
            ...
            if node_type == NodeType.ENTITY:
                ...
                pygame.draw.circle(overlay, (255, 100, 255, 150), (screen_x, screen_y), 12)
                pygame.draw.circle(overlay, (255, 255, 255, 255), (screen_x, screen_y), 12, 2)
    ...
    def _draw_info_panels(self, overlay: pygame.Surface, debug_info: Optional[Dict[str, Any]]):
        ...
        if self.current_path_result:
            y_offset += 5
            path_title = self.small_font.render("Pathfinding:", True, self.highlight_color)
    ...
    def _screen_to_world_coords(self, screen_pos: Tuple[int, int]) -> Tuple[float, float]:
