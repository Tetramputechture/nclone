...
class GeneratorRegistry:
    ...
    def _get_simplest_generators(self) -> List[Callable[[int], Map]]:
        ...
        return [
            lambda seed: self.generator._create_minimal_simple_level_vertical_corridor(seed, 0),
            lambda seed: self.generator._create_minimal_simple_level_horizontal(seed, 0),
        ]
