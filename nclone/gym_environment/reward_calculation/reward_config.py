...
class RewardConfig:
    ...
    def physics_discovery_weight(self) -> float:
        ...
        Compensates for reduced PBRS weight while encouraging physics exploration.
        
        Returns:
            0.6: Total weight for all physics discovery components
        """
        return 0.6
    ...
    def time_penalty_per_step(self) -> float:
        ...
        Returns:
            ...
            -0.001 (mid, high success): Light efficiency incentive
            -0.003 (late, high success): Full speed optimization
        """
        ...
        if self.training_phase == 'mid':
            return -0.001   # Light efficiency pressure
        return -0.003  # Full speed optimization
