...
def plot_revisit_penalties():
    ...
    plt.subplot(2, 2, 1)
    plt.plot(
        visits, current, label="Current: -0.003 × √visits", linewidth=2, color="blue"
    )
    plt.plot(
        visits,
        proposed_a,
        label="Proposed A: -0.01 × visits",
        linewidth=2,
        color="orange",
        linestyle="--",
    )
    ...
    plt.axhline(
        ...
        color="green",
        linestyle=":",
        label="Exploration bonus (for reference)",
        linewidth=2,
    )
    ...
    plt.axhline(
        y=-0.03, color="green", linestyle=":", label="Exploration bonus", linewidth=2
    )
    plt.xlabel("Visit Count", fontsize=12)
    plt.ylabel("Revisit Penalty", fontsize=12)
    ...
    plt.plot(
        visits, net_current, label="Current: Net reward", linewidth=2, color="blue"
    )
    plt.plot(
        visits,
        net_proposed_a,
        label="Proposed A: Net reward",
        linewidth=2,
        color="orange",
        linestyle="--",
    )
    ...
    plt.title(
        "Net Reward for Revisiting Explored Cells", fontsize=14, fontweight="bold"
    )
    plt.legend(fontsize=10)
    plt.grid(True, alpha=0.3)
    plt.xlim(0, 50)
    ...
    plt.tight_layout()
    plt.savefig(
        "/home/tetra/projects/nclone/docs/revisit_penalty_comparison.png",
        dpi=150,
        bbox_inches="tight",
    )
...
def plot_mine_avoidance():
    ...
    axes[0].add_patch(
        patches.Circle(
            ...
            linewidth=2,
            linestyle="--",
            label=f"Hazard radius ({mine_radius_current}px)",
        )
    )
    axes[0].set_title(
        "Current: 2× multiplier, 40px radius", fontsize=12, fontweight="bold"
    )
    ...
    axes[1].add_patch(
        patches.Circle(
            (0, 0),
            mine_radius_proposed,
            fill=False,
            edgecolor="orange",
            linewidth=2,
            linestyle="--",
            label=f"Hazard radius ({mine_radius_proposed}px)",
        )
    )
    axes[1].set_title(
        "Proposed: 8× multiplier, 60px radius", fontsize=12, fontweight="bold"
    )
    ...
    axes[2].set_title(
        "Cost Increase (Proposed - Current)", fontsize=12, fontweight="bold"
    )
    ...
    plt.tight_layout()
    plt.savefig(
        "/home/tetra/projects/nclone/docs/mine_avoidance_comparison.png",
        dpi=150,
        bbox_inches="tight",
    )
...
def plot_exploration_decay():
    ...
    current = np.where(
        success_rate < 0.10,
        0.03,
        np.where(success_rate < 0.20, 0.02, np.where(success_rate < 0.30, 0.01, 0.0)),
    )
    ...
    plt.plot(
        success_rate * 100,
        proposed,
        label="Proposed: Exponential decay",
        linewidth=2,
        color="orange",
        linestyle="--",
    )
    ...
    plt.tight_layout()
    plt.savefig(
        "/home/tetra/projects/nclone/docs/exploration_decay_comparison.png",
        dpi=150,
        bbox_inches="tight",
    )
...
def plot_time_penalty_accumulation():
    ...
    plt.plot(
        frames,
        proposed_p1_total,
        label="Phase 1: -0.0001/frame (100×)",
        linewidth=2,
        color="green",
        linestyle="--",
    )
    plt.plot(
        frames,
        proposed_p2_total,
        label="Phase 2: -0.001/frame (1000×)",
        linewidth=2,
        color="orange",
        linestyle="--",
    )
    plt.plot(
        frames,
        proposed_p3_total,
        label="Phase 3: -0.005/frame (5000×)",
        linewidth=2,
        color="red",
        linestyle="--",
    )
    ...
    plt.plot(
        frames,
        (current_total / completion_reward) * 100,
        label="Current",
        linewidth=2,
        color="blue",
    )
    plt.plot(
        frames,
        (proposed_p1_total / completion_reward) * 100,
        label="Phase 1",
        linewidth=2,
        color="green",
        linestyle="--",
    ...
    plt.plot(
        frames,
        (proposed_p2_total / completion_reward) * 100,
        label="Phase 2",
        linewidth=2,
        color="orange",
        linestyle="--",
    ...
    plt.plot(
        frames,
        (proposed_p3_total / completion_reward) * 100,
        label="Phase 3",
        linewidth=2,
        color="red",
        linestyle="--",
    ...
    plt.title(
        "Time Penalty Relative to Completion Reward", fontsize=14, fontweight="bold"
    )
    plt.legend(fontsize=10)
    plt.grid(True, alpha=0.3)
    plt.xlim(0, 3000)
    ...
    plt.ylabel("Cumulative Time Penalty", fontsize=12)
    plt.title(
        "Proposed Penalties (Typical Episode Range)", fontsize=14, fontweight="bold"
    )
    plt.legend(fontsize=10)
    plt.grid(True, alpha=0.3)
    ...
    plt.tight_layout()
    plt.savefig(
        "/home/tetra/projects/nclone/docs/time_penalty_comparison.png",
        dpi=150,
        bbox_inches="tight",
    )
...
def plot_reward_balance_summary():
    ...
    proposed_rewards = {
        ...
        "Exploration": 0.05
        * np.exp(-5 * 0.10)
        * cells_visited,  # exponential decay at 10% success
    ...
    percentages_current = [
        abs(v) / total_current * 100 for v in current_rewards.values()
    ]
    ...
    percentages_proposed = [
        abs(v) / total_proposed * 100 for v in proposed_rewards.values()
    ]
...
• Proposed: {proposed_rewards["Exploration"] + proposed_rewards["Revisit"]:.2f}
    ...
    plt.savefig(
        "/home/tetra/projects/nclone/docs/reward_balance_summary.png",
        dpi=150,
        bbox_inches="tight",
    )
...
def main():
    ...
    try:
        ...
        print(
            "  2. Read docs/reward_structure_analysis.md for detailed recommendations"
        )
