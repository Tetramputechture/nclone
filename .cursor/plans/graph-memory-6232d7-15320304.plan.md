---
name: Graph Observation Memory Optimization Plan
overview: ""
todos:
  - id: fdc930a1-ae9e-46d2-94c5-34a985afae74
    content: Add path distances (switch/exit) to reachability_features from existing _path_calculator
    status: completed
  - id: 4a765ef3-7d1b-4446-8839-9e546ea406cb
    content: Add unit direction vectors toward switch and exit goals
    status: completed
  - id: 4454b530-b419-45f7-8996-5f086600ec70
    content: Implement coarse spatial layout summary (8x8 reachability grid or radial encoding)
    status: completed
  - id: 69fa307f-dd49-4855-9ee2-53db61bc945b
    content: Update observation space to include new features, make graph optional
    status: completed
  - id: 6ed314cc-7ac1-4919-9f29-c63924935586
    content: Update policy network to use new features instead of/alongside GCN
    status: completed
  - id: b316e614-abfd-4add-9f65-4125cf1bb051
    content: Run ablation comparing graph-free vs full graph on sample efficiency
    status: pending
---
