...
class TestEnhancedTraversabilityIntegration:
    ...
    def test_precise_tile_collision_integration(self):
        ...
        result = self.edge_builder.is_precise_traversable(
            12.0,
            12.0,  # Center of empty tile (0,0)
            12.0,
            36.0,  # Center of empty tile (0,1)
            self.test_level_data,
        )
        ...
        result = self.edge_builder.is_precise_traversable(
            72.0,
            6.0,  # Top of slope tile
            96.0,
            30.0,  # Bottom-right of slope tile
            self.test_level_data,
        )
    ...
    def test_hazard_awareness_integration(self):
        ...
        result = self.edge_builder.is_traversable_with_hazards(
            3,
            3,  # Sub-cell near toggle mine
            5,
            3,  # Sub-cell through toggle mine area
            self.test_entities,
            self.test_level_data,
            self.ninja_position,
        )
    ...
    def test_bounce_block_interaction(self):
        ...
        result = self.edge_builder.is_traversable_with_hazards(
            19,
            3,  # Before bounce block
            21,
            3,  # Through bounce block
            self.test_entities,
            self.test_level_data,
            self.ninja_position,
        )
        ...
        bounce_detected = self.edge_builder._check_bounce_block_interactions(
            228.0,
            48.0,  # Before bounce block
            252.0,
            48.0,  # Through bounce block
            self.test_entities,
        )
    ...
    def test_static_hazard_caching(self):
        ...
        result1 = self.edge_builder._check_static_hazards(
            24.0, 48.0, 72.0, 48.0, self.test_level_data
        )
        ...
        result2 = self.edge_builder._check_static_hazards(
            24.0, 60.0, 72.0, 60.0, self.test_level_data
        )
    ...
    def test_dynamic_hazard_range_system(self):
        ...
        result = self.edge_builder._check_dynamic_hazards(
            180.0, 48.0, 220.0, 48.0, self.test_entities, near_drone_pos
        )
        ...
        result = self.edge_builder._check_dynamic_hazards(
            12.0, 12.0, 36.0, 12.0, self.test_entities, far_from_drone_pos
        )
    ...
    def test_performance_integration(self):
        ...
        assert elapsed_time < 2.0, (
            f"Performance test took {elapsed_time:.3f}s, expected < 2.0s"
        )
    ...
    def test_hazard_type_coverage(self):
        ...
        for entity in hazard_entities:
            ...
            assert isinstance(result, bool), (
                f"Failed to handle hazard type {entity['type']}"
            )
...
class TestMovementClassifierIntegration:
    ...
    def setup_method(self):
        ...
        self.test_level_data = {
            ...
            "tiles": np.array([[0, 1, 0], [0, 0, 0], [0, 0, 0]], dtype=np.int32),
        }
